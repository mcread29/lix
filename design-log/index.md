...
Quick index for design logs in `design-log/`.
...
- New logs use zero-padded IDs: `0002-...`, `0003-...`
- Keep statuses explicit: Draft baseline, Proposed, In implementation, Implemented
- Keep this index updated whenever a new design log is added
